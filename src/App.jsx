          ...
          <div className="sportbar-eachs">
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <p>NBA</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" version="1.1" id="Capa_1" width="40px" height="40px" viewBox="0 0 31.118 31.119">
                  <g>
                    <g>
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <p>PGA</p>
                <svg height="40px" width="40px" fill="#ffffff" version="1.1" id="Capa_1" viewBox="0 0 40.451 40.451" >
                  <g>
                    <g>
                      <g>
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" width="40px" version="1.1" id="Capa_1" viewBox="0 0 32.96 32.96">
                  <g>
                    <g>
                      <g>
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <p>MMA</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" version="1.1" x="0px" y="0px" viewBox="0 0 256 256" >
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <p>NASCAR</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 24 24" fill="#ffffff">
            ...
            <div className="sportbar-each">
              <a href="#" className="spe-content">
                ...
                <svg width="40px" height="40px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet">
